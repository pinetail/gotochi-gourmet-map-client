...
public class ShopsDao {
    ...
    public ArrayList<ShopsDto> findAll() {
        ArrayList<ShopsDto> shops = new ArrayList<ShopsDto>();
                
        Cursor cursor = db.query(TABLE_NAME, COLUMNS, null, null, null, null, COLUMN_ID);
        
        while(cursor.moveToNext()) {
            ShopsDto info = new ShopsDto();
    ...
    public ArrayList<ShopsDto> find(SharedPreferences pref, int top, int bottom, int left, int right, int lat, int lng, String sort) {
        ArrayList<ShopsDto> shops = new ArrayList<ShopsDto>();
...
//        Cursor cursor = db.query(TABLE_NAME, COLUMNS, null, null, null, null, COLUMN_ID);
    ...
    public ShopsDto findById(int rowid) {
    	ShopsDto shop = new ShopsDto();
    ...
    public ShopsDto findByTabelogId(int tabelogId) {
    	ShopsDto shop = new ShopsDto();
