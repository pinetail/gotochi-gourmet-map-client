...
import jp.pinetail.android.gotochi_gourmet_map.dto.SpotsDto;
...
public class SpotsDao {
    ...
    public ArrayList<SpotsDto> findAll() {
        ArrayList<SpotsDto> spots = new ArrayList<SpotsDto>();
                
        Cursor cursor = db.query(TABLE_NAME, COLUMNS, null, null, null, null, COLUMN_ID);
        
        while(cursor.moveToNext()) {
            SpotsDto info = new SpotsDto();
    ...
    public ArrayList<SpotsDto> find(SharedPreferences pref, int top, int bottom, int left, int right, boolean payment) {
        ArrayList<SpotsDto> spots = new ArrayList<SpotsDto>();
    ...
    public SpotsDto findById(int id) {
        SpotsDto spot = new SpotsDto();
